...
@Component({
  selector: 'app-online-movie-link-form',
  templateUrl: './online-movie-link-form.component.html',
  styleUrls: ['./online-movie-link-form.component.scss']
})
export class OnlineMovieLinkFormComponent implements OnInit {
