...
import {AgreementModalComponent} from '../sign-up/modal/agreement-modal.component';
import {PrivacyModalComponent} from '../sign-up/modal/privacy-modal.component';
...
export class SignInComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.layoutService.handsetLayout$.subscribe(x => this.isMobile = x.matches);
  }
  ...
  openTermsDialog(): void {
    this.uiService.openDialog(AgreementModalComponent, this.isMobile);
  }

  openPrivacyPolicy(): void {
    this.uiService.openDialog(PrivacyModalComponent, this.isMobile);
  }
