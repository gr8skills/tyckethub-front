...
export class EditEventTicketsComponent implements OnInit, OnDestroy {
  ...
  quantityType(): void {
    ...
    if (localEventTicketData.quantity === 2000000){
      localEventTicketData.quantity_type = 1;
    }else{
      localEventTicketData.quantity_type = 2;
    }
  }
  ...
  createEventTicket(): void {
    ...
    const payload = {
      ...
      quantity: localEventTicketData.quantity,
